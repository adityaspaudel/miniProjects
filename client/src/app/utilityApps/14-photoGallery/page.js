...
const FallbackImage = ({ src, fallback = "/noImage.jpg", ...props }) => {
  ...
  return (
    <Image
      ...
      src={imgSrc}
      onError={() => {
        setImgSrc(fallback); // swap to fallback image
      }}
    />
  );
};
const PhotoGallery = () => {
  ...
  return (
    <div className=" flex flex-col justify-center items-center min-h-screen w-screen bg-amber-50 text-black p-2">
      <h1 className="text-2xl font-semibold my-3">Photo Gallery</h1>

      <div className="flex flex-wrap  justify-between items-center p-10 overflow-hidden">
        {imageUrls.map((item) => (
          <div key={item.id} className="w-52 h-52">
            ...
            <Dialog>
              <DialogTrigger asChild>
                ...
                >
                  <FallbackImage
                    className="h-52 w-52 object-cover hover:scale-105 transition duration-300 p-2 text-black"
                    src={item?.url}
                    height={250}
                    width={250}
                    alt={item.title}
              ...
              <DialogContent className="sm:max-w-[450px] max-h-[600px]">
                ...
                <div className="flex flex-col gap-3">
                  <FallbackImage
                    ...
                    width={350}
                    alt="Preview"
                    className="rounded-md object-cover max-h-[400px] max-w-[500px]"
                  />
